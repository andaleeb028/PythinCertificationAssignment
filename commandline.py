...
while(1):
    ...
    if in1==1:
        ...
        try:
            ...
            pass
        if "@gmail.com" not in Email_ID or (len(Email_ID)*len(Username)*len(Password)*len(Contact_Number))==0 or len(str(Contact_Number))!=10 or len(Password)<=4:
        ...
        if ch==True:
            ...
            while(1):
                ...
                if in2==1:
                    ...
                    print("Enter Username")
                    usrnm=input()
                    details=operations.View_User_Details('Sellers.json',usrnm)
                    if len(details)==0:
                        print("Invalid Username")
                    else:
                        for i in range(len(details)):
                            print("Product ID: "+str(details[i]["Email"]))
                            print("Product Title: "+str(details[i]["Username"]))
                            print("Product Type: "+str(details[i]["Password"]))
                            print("Price Per Day: "+str(details[i]["Contact Number"]))
